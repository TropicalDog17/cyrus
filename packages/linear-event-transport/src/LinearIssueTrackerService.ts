...
export class LinearIssueTrackerService implements IIssueTrackerService {
	...
	private readonly tokenRefresher: LinearTokenRefresher;
	...
	constructor(
		...
		this.tokenRefresher = new LinearTokenRefresher(oauthConfig, this.logger);
		this.tokenRefresher.patchClient(linearClient);
	}
	...
	setAccessToken(token: string): void {
		...
		this.tokenRefresher.clearRefreshPromise();
